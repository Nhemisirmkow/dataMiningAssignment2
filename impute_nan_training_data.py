...
if __name__ == "__main__":
    data_path = "./datasets_preprocessed/training_removed_non_important_columns.csv"
    ...
    label_column = data['booking_bool'] * 4 + data['click_bool']
    data['rank_score'] = label_column
    print("Added label column")

    data.pop('booking_bool')
    data.pop('click_bool')
    data.pop('position')
    data.pop('gross_bookings_usd')
    ...
    data.to_csv("./datasets_preprocessed/training_set_VU_DM_without_nan.csv", index = False)
